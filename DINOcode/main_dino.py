...
def train_one_epoch(student, teacher, teacher_without_ddp, dino_loss, data_loader,
    ...
    for it, (images, _label) in enumerate(metric_logger.log_every(data_loader, 10, header)):
    ...
    torch.save(teacher, args.output_dir + '/model.pt')
    # model_scripted = torch.jit.script(teacher)  # Export to TorchScript
...
class DataAugmentationDINO(object):
    def __init__(self, global_crops_scale, local_crops_scale, local_crops_number):
        ...
        self.local_transfo = transforms.Compose([
            ...
            utils.RandomPixelsDropOut(p=0.7),
            utils.AddGaussianNoise(prob=0.7)
        ])
